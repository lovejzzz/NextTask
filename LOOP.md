...
4. **Curriculum's last open item** — worth-it quick wins (fast **and** meaningful,
   not just nearest-done). Judgment L3→L4. Closes the syllabus.
5. **Shrink the residue** — keep only genuinely board-less facts in the trace
